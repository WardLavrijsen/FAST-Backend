...
public class FootbalAPI {
    ...
    public static HttpResponse<JsonNode> Leagues() throws Exception {
        ...
        // vaders
        HttpResponse<JsonNode> response = Unirest.get("https://api-football-v1.p.rapidapi.com/v3/leagues?season=2022")
    ...
    public static HttpResponse<JsonNode> Games(String id) throws Exception {
        // eigen
        // HttpResponse<JsonNode> response = Unirest
        // .get("https://v3.football.api-sports.io/fixtures?season=2022&team=" + id)
        // .header("x-rapidapi-key", "46592bcaa6678eb4c63c300054402f18")
        // .header("x-rapidapi-host", "v3.football.api-sports.io")
        // .asJson();
        // return response;
